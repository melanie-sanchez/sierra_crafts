    ...
    <HeaderContainer>
      <Nav>
        ...
        <NavLinks>
          ...
          <StyledNavLink to="/calendar">Events</StyledNavLink>
          <StyledNavLink to="candles">Candles</StyledNavLink>
          <StyledNavLink to="/earrings">Earrings</StyledNavLink>
          <StyledNavLink to="/stickers">Stickers</StyledNavLink>
